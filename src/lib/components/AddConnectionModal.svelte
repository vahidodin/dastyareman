<script lang="ts">
	...
	const selectClass =
		'bg-transparent pe-5 outline-hidden placeholder:text-gray-300 dark:placeholder:text-gray-700';
								...
								`}>{$i18n.t('Provider')}</label
									...
									<div>
										<select
											id="provider-select"
											bind:value={provider}
											class="text-xs text-gray-700 dark:text-gray-300 bg-transparent pe-5 outline-hidden"
										>
