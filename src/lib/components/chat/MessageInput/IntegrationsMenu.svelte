							...
							>
								...
								<div class="flex items-center w-full justify-between">
									<div class=" line-clamp-1">
										{$i18n.t('Tools')}
										<span class="ms-0.5 text-gray-500">{Object.keys(tools).length}</span>
									</div>
						...
						{#if skills && Object.keys(skills).length > 0}
							...
							>
								...
								<div class="flex items-center w-full justify-between">
									<div class=" line-clamp-1">
										{$i18n.t('Skills')}
										<span class="ms-0.5 text-gray-500">{Object.keys(skills).length}</span>
									</div>
				...
				<div class="flex max-h-72 min-h-0 flex-col gap-0.5" in:fly={{ x: 20, duration: 150 }}>
					...
					>
						...
						<div class="flex items-center w-full justify-between">
							<div>
								{$i18n.t('Tools')}
								<span class="ms-0.5 text-gray-500">{toolIds.length}</span>
							</div>
						</div>
					</button>
				...
				<div class="flex max-h-72 min-h-0 flex-col gap-0.5" in:fly={{ x: 20, duration: 150 }}>
					...
					>
						...
						<div class="flex items-center w-full justify-between">
							<div>
								{$i18n.t('Skills')}
								<span class="ms-0.5 text-gray-500">{skillIds.length}</span>
							</div>
						</div>
					</button>
