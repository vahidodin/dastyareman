...
<Modal size="lg" bind:show>
	<div>
		...
		<div class="flex flex-col md:flex-row w-full px-6 pb-5 md:space-x-4">
			<div
				class="flex flex-col w-full dark:text-gray-200 overflow-y-scroll max-h-[22rem] scrollbar-hidden text-start text-sm gap-2"
			>
				{#each citations as citation, idx}
					...
					>
						...
						<div
							class="flex-1 truncate text-black/60 hover:text-black dark:text-white/60 dark:hover:text-white transition text-start"
						>
