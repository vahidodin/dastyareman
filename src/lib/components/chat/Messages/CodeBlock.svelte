...
<div>
	...
	>
		...
		{:else}
			<div
				class="sticky {stickyButtonsClassName} start-0 end-0 py-1.5 px-3.5 gap-2 flex items-center justify-end w-full z-10 text-xs text-black dark:text-white bg-white dark:bg-black"
			>
