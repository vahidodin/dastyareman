...
<div class="w-full min-w-0 pb-1">
	<button
		type="button"
		class="w-full min-w-0 flex items-center gap-2 text-start text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors"
	...
	{#if expanded}
		<div
			class="mt-2 ms-3 border-s border-gray-100 dark:border-white/8 ps-3 text-[0.78125rem] leading-relaxed text-gray-600 dark:text-gray-400 whitespace-pre-wrap break-words"
		>
			{content}
		</div>
	{/if}
