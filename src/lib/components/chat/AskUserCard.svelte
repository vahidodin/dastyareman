		...
		<div class="space-y-2">
						...
						<div>
							<div class="flex items-center justify-between gap-3">
								...
								{#if questions.length > 1}
									<div
										class="shrink-0 text-end text-[0.6875rem] text-gray-500 dark:text-gray-400"
									>
						...
						<div class="space-y-1">
							<div class="space-y-0.5">
								{#each question.options || [] as option, optionIndex}
									<button
										type="button"
										class="group flex w-full min-w-0 items-baseline gap-2 rounded-lg py-1.5 text-start transition-colors {isSelectedOption(
											question,
											optionIndex
										)
			...
			<div class="flex items-center justify-between gap-2">
				<div class="flex items-center gap-1.5">
					<button
						type="button"
						class="rounded-full py-1 pe-2.5 text-xs text-gray-500 transition-colors hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-100"
						on:click={cancel}
					>
						{$i18n.t('Cancel')}
					</button>
