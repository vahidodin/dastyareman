				...
				>
					...
					>
						<input
							...
							class="h-7 w-24 rounded-lg border border-gray-100/50 bg-gray-50/40 px-2 text-end text-xs text-gray-700 outline-hidden transition-colors placeholder:text-gray-300 focus:border-blue-400 dark:border-white/[0.04] dark:bg-white/[0.03] dark:text-gray-300 dark:placeholder:text-gray-700 dark:focus:border-blue-500"
						/>
					</Tooltip>
				</UserSettingRow>
			{/if}
			...
			>
				<div class="relative flex items-center gap-1.5 text-xs text-gray-400 dark:text-gray-600">
					<input
						...
						class="h-7 w-16 rounded-lg border border-gray-100/50 bg-gray-50/40 px-2 text-end text-xs text-gray-700 outline-hidden transition-colors focus:border-blue-400 dark:border-white/[0.04] dark:bg-white/[0.03] dark:text-gray-300 dark:focus:border-blue-500"
					/>
					x
				</div>
			</UserSettingRow>
