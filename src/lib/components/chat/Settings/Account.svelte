...
>
	<div class="flex-1 min-h-0 w-full overflow-y-auto scrollbar-hover pe-1.5">
						...
						{#if $user?.role === 'admin'}
							...
							>
								<div class="flex">
									...
									<button
										class="ms-1.5 rounded-sm px-1.5 py-1 text-gray-500 transition hover:text-gray-700 dark:hover:text-gray-300"
