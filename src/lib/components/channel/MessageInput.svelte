...
{#if loaded}
	...
	<div class="bg-transparent">
		<div class="max-w-full mx-auto inset-x-0 relative">
			<div
				class="absolute top-0 start-0 end-0 mx-auto inset-x-0 bg-transparent flex justify-center"
			>
					...
					>
						...
						>
							{#if replyToMessage !== null}
								<div class="px-3 pt-3 text-start w-full flex flex-col z-10">
									<div class="flex items-center justify-between w-full">
										<div class="ps-[0.0625rem] flex items-center gap-2 text-sm">
							...
							<div class="px-2">
								<div
									class="scrollbar-hidden rtl:text-end ltr:text-start bg-transparent dark:text-gray-100 outline-hidden w-full pt-2 pb-0.5 px-1 resize-none h-fit max-h-96 overflow-auto"
								>
							...
							<div class=" flex justify-between mt-0.5 mb-2 mx-0.5 max-w-full">
								...
								<div class="self-end flex space-x-1 me-1 shrink-0 gap-[0.03125rem]">
									{#if content === ''}
										<Tooltip content={$i18n.t('Record voice')}>
											<button
												id="voice-input-button"
												class=" text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-200 transition rounded-full p-[0.3125rem] me-0.5 self-center"
												type="button"
												on:click={async () => {
													try {
