...
<Modal size="xl" bind:show>
	<div class="py-2.5 dark:text-gray-300 text-gray-700">
		...
		<div class="flex px-3.5 pb-0.5">
			<div
				class="flex flex-col overflow-y-auto h-96 md:h-[40rem] max-h-full scrollbar-hidden w-full flex-1 pe-2"
			>
				...
				{#if chatList}
					...
					{#each chatList as chat, idx (chat.id)}
						...
						<div
							class="w-full flex justify-between items-center rounded-lg text-sm py-1.5 ps-2.5 pe-32 hover:bg-gray-50/70 dark:hover:bg-gray-850/50 group/item relative {selectedIdx ===
							idx + actions.length
								? 'bg-gray-50/70 dark:bg-gray-850/50'
								: ''}"
						...
						>
							...
							<div
								class="absolute end-3 top-1/2 -translate-y-1/2 flex items-center gap-3 ps-6 shrink-0"
							>
