			...
			{#if showSearch}
				<div class=" flex w-full space-x-2 mt-0.5 mb-1.5">
					<div class="flex flex-1">
						...
						{#if query}
							<div class="self-center ps-1.5 pe-1 translate-y-[0.5px] rounded-s-xl bg-transparent">
								<button
			...
			<div class=" flex flex-col w-full sm:flex-row sm:justify-center sm:space-x-6">
				{#if chatList}
					<div class="w-full">
						...
						{/if}
						<div class="text-start text-sm w-full mb-3 max-h-[22rem] overflow-y-scroll">
							{#if chatList.length === 0}
								<div
							...
							-->
								...
								>
									...
									<div class="{showUserInfo ? 'w-28' : 'basis-2/5'} flex items-center justify-end">
										...
										{#if !readOnly}
											<div class="flex justify-end ps-2.5 text-gray-600 dark:text-gray-300">
												{#if unarchiveHandler}
				...
				<!-- {#if chats !== null}
						...
						<div class="w-full">
							<div class="text-start text-sm w-full mb-3 max-h-[22rem] overflow-y-scroll">
								<div class="relative overflow-x-auto">
									<table
										class="w-full text-sm text-start text-gray-600 dark:text-gray-400 table-auto"
									>
										<thead
					...
					{:else}
						<div class="text-start text-sm w-full mb-8">
