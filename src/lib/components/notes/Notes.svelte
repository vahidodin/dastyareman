		...
		<div class="space-y-1">
			<div class="flex h-8 flex-1 items-center w-full gap-2">
				<div class="flex min-w-0 flex-1 items-center">
					<div class=" self-center ms-1 me-3">
						<Search className="size-3.5" />
					</div>
					<input
						class=" w-full text-sm py-1 rounded-e-xl outline-hidden bg-transparent"
						bind:value={query}
					...
					{#if query}
						<div class="self-center ps-1.5 translate-y-[0.5px] rounded-s-xl bg-transparent">
							<button
						...
						<div>
							{#if displayOption === null}
								...
								>
									<div class="flex min-w-0 flex-1 items-center">
										<button
											class="flex min-w-0 items-center gap-1 py-0.5 text-start"
											type="button"
									...
									<div class="ms-2 flex shrink-0 items-center justify-end gap-2">
										<div class="hidden w-44 shrink-0 md:block"></div>
										<div class="size-5 shrink-0"></div>
										<button
											class="flex w-24 shrink-0 items-center justify-end gap-1 py-0.5 text-end"
											type="button"
							...
							{#each groupedNotes as [timeRange, notesList], idx}
									...
									>
										{#each notesList as note, idx (note.id)}
											<button
												...
												class="group flex min-h-8 w-full items-center gap-2 rounded-xl px-2 py-[0.375rem] text-start transition hover:bg-gray-50 focus-within:bg-gray-50 dark:hover:bg-gray-900 dark:focus-within:bg-gray-900"
												on:click={() => {
													goto(`/notes/${note.id}`);
												}}
											>
												...
												<div class="ms-2 flex shrink-0 items-center justify-end gap-2">
													<div
														class="hidden max-w-44 shrink-0 truncate text-end text-[0.6875rem] leading-5 text-gray-500 dark:text-gray-500 md:block"
													>
														<Tooltip
								...
								{:else if displayOption === 'grid'}
									...
									>
										{#each notesList as note, idx (note.id)}
											<div
												class="group flex min-h-32 w-full flex-col rounded-lg bg-gray-50/40 p-2.5 text-start transition hover:bg-gray-100/60 focus-within:bg-gray-100/60 dark:bg-gray-900/30 dark:hover:bg-gray-900 dark:focus-within:bg-gray-900"
											>
