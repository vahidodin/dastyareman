	...
	<div class="w-full h-fit mb-1.5">
		...
		<div class="flex flex-1 h-fit items-center gap-2">
			<div class="flex min-w-0 flex-1 items-center">
				...
				<input
					class=" w-full text-sm pe-4 rounded-e-xl outline-hidden bg-transparent"
					bind:value={query}
			...
			<Dropdown bind:show={showImportMenu} align="end" sideOffset={6}>
				<button
					class="ms-1 flex shrink-0 items-center gap-0.5 rounded-lg px-1 py-0.5 text-xs font-normal text-gray-500 transition hover:text-gray-700 disabled:cursor-not-allowed disabled:opacity-60 dark:text-gray-400 dark:hover:text-gray-200"
					type="button"
				...
				>
					<thead class="text-xs text-gray-800 uppercase bg-transparent dark:text-gray-200">
						<tr class=" border-b-[1.5px] border-gray-50/50 dark:border-gray-800/10">
							<th
								scope="col"
								class="px-2.5 py-1.5 cursor-pointer text-start w-8"
