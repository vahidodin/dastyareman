				...
				>
					<thead class="text-xs text-gray-800 uppercase bg-transparent dark:text-gray-200">
						<tr class=" border-b-[1.5px] border-gray-50 dark:border-gray-850/30">
							...
							<th
								scope="col"
								class="px-2.5 py-2 font-normal text-end cursor-pointer select-none w-fit"
							...
							<th
								scope="col"
								class="px-2.5 py-2 font-normal text-end cursor-pointer select-none w-0"
					...
					<tbody class="">
						{#each items as feedback (feedback.id)}
							...
							>
								<td class=" py-0.5 text-end font-normal">
								...
								<td class=" py-1 ps-3 flex flex-col">
								...
								{#if feedback?.data?.rating}
									<td class="px-3 py-1 text-end font-normal text-gray-900 dark:text-white w-max">
								...
								<td class=" px-3 py-1 text-end font-normal">
									{dayjs(feedback.updated_at * 1000).fromNow()}
								</td>

								<td class=" px-3 py-1 text-end font-normal" on:click={(e) => e.stopPropagation()}>
									<FeedbackMenu
										on:delete={(e) => {
