			...
			>
				<thead class="text-xs text-gray-800 uppercase bg-transparent dark:text-gray-200">
					<tr class="border-b-[1.5px] border-gray-50 dark:border-gray-850/30">
						{#each [{ key: 'rating', label: 'RK', class: 'w-3' }, { key: 'name', label: $i18n.t('Model'), class: '' }, { key: 'rating', label: $i18n.t('Rating'), class: 'text-end w-fit' }, { key: 'won', label: $i18n.t('Won'), class: 'text-end w-5' }, { key: 'lost', label: $i18n.t('Lost'), class: 'text-end w-5' }] as col}
							<th
								scope="col"
				...
				<tbody>
					{#each sortedModels as model, idx (model.id)}
						...
						>
							...
							<td class="px-3 py-1.5 text-end font-normal text-gray-900 dark:text-white">
								{model.rating}
							</td>
							<td class="px-3 py-1.5 text-end font-normal text-green-500 w-10">
							...
							<td class="px-3 py-1.5 text-end font-normal text-red-500 w-10">
