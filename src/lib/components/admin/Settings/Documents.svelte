		...
		<div class="flex-1 min-h-0 overflow-y-auto scrollbar-hover pe-1.5">
			...
			>
				...
				{:else if RAGConfig.CONTENT_EXTRACTION_ENGINE === 'mineru'}
					...
					>
						<input
							class="w-16 rounded-lg border border-gray-100/50 bg-gray-50/40 px-2 text-end text-xs text-gray-700 outline-hidden transition-colors focus:border-blue-400 dark:border-white/[0.04] dark:bg-white/[0.03] dark:text-gray-300 dark:focus:border-blue-500"
							type="number"
							min="1"
