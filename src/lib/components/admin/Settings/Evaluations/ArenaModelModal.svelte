					...
					<div class="px-1">
						...
						<div class="flex justify-center pb-3">
							...
							>
								...
								<div
									class="absolute flex justify-center rounded-full bottom-0 start-0 end-0 top-0 h-full w-full overflow-hidden bg-gray-700 bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-50"
								>
