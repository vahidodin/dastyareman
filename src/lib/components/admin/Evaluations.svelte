...
{#if loaded}
	<div class="flex flex-col lg:flex-row w-full h-full pb-2 lg:space-x-4">
		<div
			...
			class="tabs mx-2 px-2 sm:mx-2.5 lg:mx-0 lg:px-2.5 flex flex-row overflow-x-auto gap-2.5 max-w-full lg:gap-0 lg:flex-col lg:flex-none lg:w-50 dark:text-gray-200 text-sm font-normal text-start scrollbar-none"
		>
			<a
				id="leaderboard"
				href="/admin/evaluations/leaderboard"
				draggable="false"
				class="px-0.5 py-1 min-w-fit rounded-lg lg:flex-none flex items-center gap-1.5 text-end transition select-none {selectedTab ===
				'leaderboard'
					? ''
		...
		<div class="flex-1 mt-1 lg:mt-0 px-[1rem] lg:pe-[1rem] lg:ps-0 overflow-y-scroll">
