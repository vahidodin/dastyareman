...
{#if !dismissed}
	{#if mounted}
		<div
			class="{className} top-0 start-0 end-0 py-1 flex justify-center items-center relative border border-transparent text-gray-800 dark:text-gary-100 bg-transparent backdrop-blur-xl z-30"
		...
		>
				...
				<div class="flex justify-between self-start">
					<div
						class=" text-xs font-normal {classNames[banner.type] ??
							classNames['info']}  w-fit px-2 rounded-sm uppercase line-clamp-1 me-0.5"
					>
					...
					{#if banner.url}
						<div class="flex md:hidden group w-fit md:items-center">
							...
							<div
								class=" ms-1 text-gray-400 group-hover:text-gray-600 dark:group-hover:text-white"
							>
								<!--  -->
								<svg
									aria-hidden="true"
			...
			{#if banner.url}
				<div class="hidden md:flex group w-fit md:items-center">
					...
					<div class=" ms-1 text-gray-400 group-hover:text-gray-600 dark:group-hover:text-white">
						<!--  -->
						<svg
							aria-hidden="true"
							xmlns="http://www.w3.org/2000/svg"
			...
			<div class="flex self-start">
				<button
					...
					class="  -mt-1 -mb-2 -translate-y-[1px] ms-1.5 me-1 text-gray-400 dark:hover:text-white"
					>&times;</button
				>
			</div>
		</div>
