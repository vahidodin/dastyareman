							...
							{:else if displaySpec.properties[property]?.input?.type === 'map'}
								...
								<div class="flex flex-col items-center gap-1">
									...
									{#if valves[property]}
										<input
											type="text"
											class=" w-full rounded-lg py-1 text-start text-sm dark:text-gray-300 dark:bg-gray-850 outline-hidden border border-gray-100/30 dark:border-gray-850/30"
