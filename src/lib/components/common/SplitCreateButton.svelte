...
{#if visibleActions.length === 1}
	<button
		class="focus-ring ms-1 rounded-lg bg-gray-50 px-2.5 py-1 text-xs text-gray-900 transition ring-1 ring-gray-200 hover:bg-gray-100 dark:bg-gray-850 dark:text-gray-100 dark:ring-gray-800 dark:hover:bg-gray-800"
		type="button"
		on:click={() => {
...
{:else if visibleActions.length > 1}
	<div
		class="ms-1 flex overflow-hidden rounded-lg bg-gray-50 text-xs text-gray-900 transition ring-1 ring-gray-200 dark:bg-gray-850 dark:text-gray-100 dark:ring-gray-800"
	>
		<button
		...
		<Dropdown bind:show={showMenu} align="end" sideOffset={6}>
			<button
				class="focus-ring flex items-center border-s border-gray-200 px-1.5 py-1 transition hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800"
