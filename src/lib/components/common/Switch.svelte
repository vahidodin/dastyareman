...
>
	<div class="flex items-center gap-1.5">
		...
		>
			<Switch.Thumb
				class="pointer-events-none absolute top-[0.125rem] block h-3 w-3 shrink-0 rounded-full transition-all duration-150 data-[state=checked]:start-[0.875rem] data-[state=checked]:bg-white data-[state=checked]:dark:bg-black data-[state=unchecked]:start-[0.125rem] data-[state=unchecked]:bg-white data-[state=unchecked]:dark:bg-gray-500"
			/>
		</Switch.Root>
	</div>
</Tooltip>
