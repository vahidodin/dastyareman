<script lang="ts">
	...
	$: buttonClass =
		variant === 'settings'
			? `ms-1.5 bg-transparent text-gray-400 transition hover:text-gray-700 dark:text-gray-500 dark:hover:text-gray-300 ${showButtonClassName}`
			: `ps-1.5 bg-transparent transition ${showButtonClassName}`;
</script>
