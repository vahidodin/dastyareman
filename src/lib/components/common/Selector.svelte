		...
		<slot>
			...
			<div class="px-3 my-2 max-h-80 overflow-y-auto">
				{#each filteredItems as item}
					<button
						class="flex w-full font-normal line-clamp-1 select-none items-center rounded-button py-2 ps-3 pe-1.5 text-sm text-gray-700 dark:text-gray-100 outline-hidden transition-all duration-75 hover:bg-gray-100 dark:hover:bg-gray-850 rounded-lg cursor-pointer"
						type="button"
