		...
		{#if models !== null}
			{#if (models ?? []).length !== 0}
				<div class="my-1" id="model-list">
					...
					>
						<button
							class="flex min-w-0 flex-1 items-center gap-1 py-0.5 text-start"
							type="button"
						...
						<button
							class="flex w-36 shrink-0 items-center justify-end gap-1 py-0.5 text-end"
							type="button"
					...
					<div class="grid gap-y-0.5">
						{#each models as model (model.id)}
							...
							<div
								class="group flex min-h-8 w-full items-center gap-2 overflow-hidden rounded-xl px-2 py-1 text-start {model.write_access
									? 'cursor-pointer'
							...
							>
								<div class="me-1 shrink-0 self-center">
								...
								<div
									class="hidden max-w-44 shrink-0 self-center truncate text-end text-[0.6875rem] leading-5 text-gray-500 dark:text-gray-500 md:block"
								>
									<Tooltip
								...
								<div class="ms-2 flex shrink-0 flex-row items-center self-center">
									{#if shiftKey && model.write_access}
										...
										<Tooltip content={$i18n.t('Delete')}>
											<button
												class="ms-0.5 flex size-6 items-center justify-center rounded-lg text-gray-400 transition dark:text-gray-500"
												type="button"
