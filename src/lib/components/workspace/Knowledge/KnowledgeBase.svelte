				...
				<div class="flex-1 px-1">
					<div class="flex items-center justify-between w-full">
						<div class="w-full flex justify-between items-center">
							<input
								type="text"
								class="text-start w-full text-sm bg-transparent outline-hidden flex-1"
					...
					<div class="flex w-full items-center">
						<input
							type="text"
							class="text-start text-xs w-full text-gray-500 bg-transparent outline-hidden flex-1"
			...
			{:else}
				<div class="px-3 flex flex-1 items-center w-full space-x-1.5">
					<div class="flex flex-1 items-center">
						<div class=" self-center ms-1 me-2">
							<Search className="size-3.5" />
						</div>
						<input
							class=" w-full text-xs pe-4 py-1 rounded-e-xl outline-hidden bg-transparent"
							bind:value={query}
						...
						<Dropdown align="end">
							<button
								class="p-1.5 me-1 rounded-xl text-gray-500 bg-transparent hover:text-gray-900 dark:hover:text-gray-100 transition"
								type="button"
							>
								...
								<div class="flex flex-col justify-start h-full max-h-full">
									<div class=" flex flex-col w-full h-full max-h-full">
										<div class="shrink-0 flex items-center p-2">
											<div class="me-2">
												<button
													class="w-full text-start text-xs p-1.5 rounded-lg dark:text-gray-300 dark:hover:text-white hover:bg-black/5 dark:hover:bg-gray-850"
