			...
			>
				...
				<div class="flex max-h-56 flex-col gap-0.5 overflow-y-scroll">
					{#if selectedIds !== null && matchedItems.length > 0}
						<button
							type="button"
							class="h-[1.6875rem] w-full rounded-xl px-2 text-start text-[0.8125rem] text-gray-700 transition-colors hover:bg-gray-50/40 hover:text-gray-900 dark:text-gray-200 dark:hover:bg-gray-800/40 dark:hover:text-gray-100"
					...
					{:else}
						{#each matchedItems as item (item.id)}
							<button
								type="button"
								class="flex h-[1.6875rem] w-full items-center justify-between gap-2 rounded-xl px-2 text-start text-[0.8125rem] transition-colors hover:bg-gray-50/40 hover:text-gray-900 dark:hover:bg-gray-800/40 dark:hover:text-gray-100 selected-command-option-button"
