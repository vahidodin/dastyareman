			...
			<div class="max-h-56 overflow-y-scroll gap-0.5 flex flex-col">
				...
				{:else}
					{#each items as item, i}
						...
						<div
							class="min-h-[1.6875rem] px-2 rounded-xl w-full text-start flex justify-between items-center text-[0.8125rem] bg-transparent transition-colors hover:bg-gray-50/40 hover:text-gray-900 dark:hover:bg-gray-800/40 dark:hover:text-gray-100 selected-command-option-button"
						>
							<button
								class="w-full flex-1"
								type="button"
							...
							>
								<div class="  text-black dark:text-gray-100 flex items-center gap-1 shrink-0">
									...
									<Tooltip
										...
										tippyOptions={{ zIndex: 100000 }}
									>
										<div class="line-clamp-1 flex-1 text-[0.8125rem] text-start">
