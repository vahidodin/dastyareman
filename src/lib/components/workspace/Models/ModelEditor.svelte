...
{#if loaded}
	...
	<div class="flex h-full min-h-0 w-full flex-col">
		...
		<div class="min-h-0 w-full flex-1 overflow-y-auto pe-1 scrollbar-hover">
			<input
					...
					<div class="w-full px-1">
								...
								<div class="flex min-w-0 flex-1 items-center gap-3">
									...
									<div class="group relative size-12 shrink-0 md:size-14">
										...
										>
											...
											<div
												class="absolute bottom-0 end-0 z-10 opacity-0 transition group-hover:opacity-100 group-focus-within:opacity-100"
											>
												<div class="m-1">
													<div
										...
										{#if info.meta.profile_image_url && info.meta.profile_image_url !== `${WEBUI_BASE_URL}/static/favicon.png`}
											<button
												class="absolute start-1/2 top-full mt-1 -translate-x-1/2 text-[0.5rem] leading-none text-gray-400 opacity-0 transition group-hover:opacity-60 hover:text-gray-500 hover:opacity-100 group-focus-within:opacity-60 dark:text-gray-600 dark:hover:text-gray-400"
												on:click={() => {
						...
						<div class="my-2 text-gray-300 dark:text-gray-700 pb-20">
							<div class="flex w-full justify-between mb-2">
								...
								>
									{#if showPreview}
										<span class="ms-2 self-center">{$i18n.t('Hide')}</span>
									{:else}
										<span class="ms-2 self-center">{$i18n.t('Show')}</span>
									{/if}
								</button>
							</div>
