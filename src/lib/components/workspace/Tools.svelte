			...
			<div class="my-1">
				...
				<div class="grid gap-y-0.5">
					{#each filteredItems as tool}
						<div
							class="group flex min-h-8 w-full items-center gap-2 overflow-hidden rounded-xl px-2 py-1 text-start {tool.write_access
								? 'cursor-pointer'
						...
						>
							...
							{#if tool.write_access}
								<div class="ms-2 flex shrink-0 flex-row items-center gap-1.5 self-center">
									{#if shiftKey}
	...
	>
		<div class="text-sm text-gray-500">
			<div class=" bg-yellow-500/20 text-yellow-700 dark:text-yellow-200 rounded-lg px-4 py-3">
				...
				<ul class=" mt-1 list-disc ps-4 text-xs">
					<li>
