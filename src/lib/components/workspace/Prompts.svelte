	...
	<div class="space-y-1">
		<div class="flex h-8 w-full items-center gap-2">
			<div class="flex min-w-0 flex-1">
				...
				<input
					class=" w-full text-sm pe-4 py-1 rounded-e-xl outline-hidden bg-transparent"
					bind:value={query}
			...
			<div class="my-1">
				...
				<div class="grid gap-y-0.5">
					{#each prompts as prompt (prompt.id)}
						<div
							class="group flex min-h-8 w-full cursor-pointer items-center gap-2 overflow-hidden rounded-xl px-2 py-1 text-start"
							role="button"
							tabindex="0"
							on:click={(e) => {
						...
						>
							...
							<div class="ms-2 flex shrink-0 flex-row items-center self-center">
								...
								{:else}
									...
									<div class="ms-0.5 flex shrink-0 flex-row items-center gap-1.5 self-center">
										<PromptMenu
