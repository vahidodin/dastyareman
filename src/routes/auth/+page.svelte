...
<div class="w-full h-screen max-h-[100dvh] text-white relative" id="auth-page">
	<div class="w-full h-full absolute top-0 start-0 bg-white dark:bg-black"></div>

	<div class="w-full absolute top-0 start-0 end-0 h-8 drag-region" />
							...
							>
								...
								{#if $config?.features.enable_login_form || $config?.features.enable_ldap || form}
									<div class="flex flex-col mt-4">
										{#if mode === 'signup'}
											<div class="mb-2">
												<label for="name" class="text-sm font-normal text-start mb-1 block"
													>{$i18n.t('Name')}</label
												>
												<input
													bind:value={name}
										...
										{#if mode === 'ldap'}
											<div class="mb-2">
												<label for="username" class="text-sm font-normal text-start mb-1 block"
										...
										{:else}
											<div class="mb-2">
												<label for="email" class="text-sm font-normal text-start mb-1 block"
													>{$i18n.t('Email')}</label
												>
												<input
													bind:value={email}
										...
										<div>
											<label for="password" class="text-sm font-normal text-start mb-1 block"
										...
										{#if mode === 'signup' && $config?.features?.enable_signup_password_confirmation}
											<div class="mt-2">
												<label
													...
													class="text-sm font-normal text-start mb-1 block"
