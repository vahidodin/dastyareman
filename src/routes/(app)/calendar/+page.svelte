...
>
	{#if loaded}
			...
			<div class="flex items-center gap-0.5 md:gap-1">
				...
				<div class="flex w-full items-center">
					...
					<div class="ms-auto flex items-center gap-1">
						...
						<button
							class="ms-1 rounded-lg bg-gray-50 px-2.5 py-1 text-xs text-gray-900 transition ring-1 ring-gray-200 hover:bg-gray-100 dark:bg-gray-850 dark:text-gray-100 dark:ring-gray-800 dark:hover:bg-gray-800"
		...
		<div class="flex flex-1 min-h-0">
			<!-- Sidebar -->
			<div class="hidden md:flex flex-col w-56 shrink-0 pe-1.5 ps-3 overflow-y-auto">
				<CalendarSidebar
					{calendars}
					{visibleCalendarIds}
					{currentDate}
