...
_favicon_path = '/static/favicon.png'
WEBUI_FAVICON_URL = os.getenv('WEBUI_FAVICON_URL', '').strip()
if not WEBUI_FAVICON_URL:
    _webui_url = os.getenv('WEBUI_URL', '').rstrip('/')
    WEBUI_FAVICON_URL = f'{_webui_url}{_favicon_path}' if _webui_url else _favicon_path
